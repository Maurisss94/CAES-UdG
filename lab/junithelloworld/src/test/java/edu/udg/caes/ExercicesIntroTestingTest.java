...
public class ExercicesIntroTestingTest {
    ...
    public void testFindLastOK(){
        final int result = ExercicesIntroTesting.findLast(new int []{2, 3, 5}, 5);
    ...
    public void testLastZeroOK(){
        final int result = ExercicesIntroTesting.lastZero(new int []{2, 1, 0, 0});
    ...
    public void testOddOrPosOK(){
        final int result = ExercicesIntroTesting.oddOrPos(new int []{-3, -2, 0, 1, 3, 5, 7, -2});
